...
files_string="netstat.out vmstat.out ps.aux.out ps.out ps.threads.out top.out screen.out dmesg.out whoami.out df-hk.out uptime.out $tarred_javacores_string $ifconfig_file"
for pid in $pids
do
